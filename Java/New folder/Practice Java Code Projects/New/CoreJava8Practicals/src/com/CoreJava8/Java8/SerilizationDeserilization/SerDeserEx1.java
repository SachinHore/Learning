package com.CoreJava8.Java8.SerilizationDeserilization;
...
public class SerDeserEx1 {
    public static void main(String[] args) {
       ...
       try{
       ...
       }catch(IOException e){System.out.println("IO Exception occur"+e);}
        ...
        try{
            ...
            //closing the stream
            in.close();
        }catch(ClassNotFoundException e){System.out.println("Class not found occur"+e);}
        catch(IOException e){System.out.println("IO Exception occur"+e);}
    }
}
