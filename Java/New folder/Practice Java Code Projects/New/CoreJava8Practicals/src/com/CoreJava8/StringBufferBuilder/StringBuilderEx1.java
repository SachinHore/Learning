...
public class StringBuilderEx1 {
    public static void main(String[] args) {
        StringBuilder name = new StringBuilder("Sachin"); //new 1 obj create in Heap
        StringBuilder name1 = new StringBuilder("Sachin"); //new 1 obj create in Heap
        ...
        StringBuilder s = name.append(" Hore"); //name= SachinHore -> SachinHore Hore
